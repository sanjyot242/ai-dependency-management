...
const Login: React.FC = () => {
    ...
    if (errorParam) {
      switch (errorParam) {
        case 'oauth_error':
          ...
          break;
        case 'invalid_state':
          setError('Invalid OAuth state. This could be due to an expired session or a security issue.');
          break;
        case 'token_error':
  ...
  const handleLogin = () => {// Store current path for potential redirect after login
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white mb-2">AI Dependency Manager</h1>
      ...
      <div className="mt-8 text-center text-gray-400 text-sm">
        <p>© {new Date().getFullYear()} AI Dependency Manager. All rights reserved.</p>
      </div>
    </div>
  );
};
